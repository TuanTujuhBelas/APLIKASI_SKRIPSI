...
class rebanaScreen extends StatelessWidget {
  final List<String> imgList = [
    "assets/logo/rebana.jpg",
    "assets/logo/rebana2.jpg",
    "assets/logo/rebana3.jpg",
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:
            Text('Alat Musik Rebana', style: TextStyle(fontFamily: "Poppins")),
      ),
      body: ListView(
        children: [
          Column(
